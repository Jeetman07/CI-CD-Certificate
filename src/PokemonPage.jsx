...
const PokemonPage = ({ previous, next }) => {
  ...
  const { type } = pokemon.types.find((t) => t.slot === 1)
  ...
  const normalAbility = pokemon.abilities.find((a) => !a.is_hidden)
  const hiddenAbility = pokemon.abilities.find((a) => a.is_hidden === true)
